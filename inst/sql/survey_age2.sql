...
FROM
    ...
    INNER JOIN gap_products.akfin_specimen ON akr.species_translation.from_code = gap_products.akfin_specimen.species_code
    INNER JOIN gap_products.akfin_haul ON gap_products.akfin_haul.hauljoin = gap_products.akfin_specimen.hauljoin
